      ...
      <div v-if="showFilters" class="filter-dropdown-menu">
        ...
        <div class="filter-grid">
          <div class="filter-item">
            ...
            <select v-model="filters.category_ids" class="filter-select" multiple>
          ...
          <div class="filter-item">
            <label class="filter-label">End Datum</label>
          ...
          <div class="filter-item">
            <label class="filter-label">Sortierung nach Datum</label>
            <select v-model="filters.sort_by_end_date" class="filter-select">
          ...
          <div class="filter-item">
            <label class="filter-label">Anzahl der Aufgaben</label>
